...
Tagline cá nhân:
“Biến ý tưởng thành trải nghiệm trực quan đầy cảm hứng.”
Mô tả ngắn:
Sinh viên chuyên ngành Đồ họa Kỹ thuật số, yêu thích thiết kế poster, giao diện website, chỉnh sửa ảnh và xây dựng trải nghiệm người dùng hiện đại.
2. Công nghệ sử dụng
HTML5
CSS3 thuần
...
Text Gray: #b8b8d1
Typography:
Font: Poppins hoặc Montserrat
Tiêu đề lớn, đậm, hiện đại
Hiệu ứng:
Gradient background
Hover glow màu hồng
...
Họ tên lớn: Lâm Bích Ngọc
Vai trò nghề nghiệp
Câu mô tả ngắn mang dấu ấn cá nhân
2 nút CTA:
View Projects
Contact Me
2. About Section
...
Thông tin cá nhân
Định hướng nghề nghiệp: trở thành UX/UI Designer hoặc Graphic Designer
Điểm mạnh:
Thiết kế Poster
...
Đại học – Chuyên ngành Đồ họa Kỹ thuật số
Các môn đã học:
Thiết kế Poster
Thiết kế UI Website
Xử lý ảnh
